...
export const metadata = {
  title:
    "Hotels in Ayodhya Book with Free Cancellation | Paarvi Palace Near Ram Mandir",
  description:
      ...
      <div className="max-w-7xl mx-auto px-6 py-24">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="mt-6 text-gray-600 leading-relaxed">
              ...
              hotels in Ayodhya book with free cancellation. Whether your plans
              are fixed or still evolving, our stay experience is designed to
              keep your visit comfortable, simple, and stress-free.
            </p>

            <p className="mt-6 text-gray-600 leading-relaxed">
              With clean rooms, family-friendly options, and convenient access
              to Ram Mandir and other key attractions, Paarvi Palace offers a
              peaceful base for pilgrims, couples, and families visiting
              Ayodhya.
            </p>
            ...
            <div className="mt-10">
              ...
              <ul className="mt-6 space-y-3 text-gray-600 leading-relaxed list-disc list-inside">
                <li>Comfortable stay option for travellers visiting Ayodhya</li>
                <li>Flexible booking convenience for changing travel plans</li>
                ...
                <li>Convenient location near Ram Mandir and local attractions</li>
              </ul>
            </div>
        ...
        <div className="mt-28">
          ...
          <p className="mt-4 text-center text-gray-600 max-w-2xl mx-auto">
            Explore the rooms and spaces that make Paarvi Palace a comfortable
            choice for travellers visiting Ayodhya.
          </p>
